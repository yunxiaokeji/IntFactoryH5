...
namespace UnitTestIntFactory
{
    ...
    public class UnitTestTask
    {
        ...
        {
            var result= TaskBusiness.BaseBusiness.GetTasks(new FilterTasks(),userID, clientID);
        ...
        public void GetTaskDetail()
        {
            ...
            var result = TaskBusiness.BaseBusiness.GetTaskDetail(taskID, userID, clientID);
            Assert.IsTrue(result.error_code == 0);
        }
        ...
        public void GetOrderInfo()
        {
            ...
            var result = TaskBusiness.BaseBusiness.GetOrderInfo(orderID, userID, clientID);
            Assert.IsTrue(result.error_code == 0);
        }
    }
}
